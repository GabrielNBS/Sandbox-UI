...
export const AppleFeatureAccordionItem: React.FC<AppleFeatureAccordionItemProps> = ({
	...
	return (
		<motion.button
			...
			className={`relative overflow-hidden text-left block focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 border border-transparent transition-colors ${
				isActive
